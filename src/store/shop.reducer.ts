import { initalState, ShopAction, LOAD_PRODUCTS, ADD_PRODUCT_TO_CART, CartProductProps, REMOVE_PRODUCT_FROM_CART } from "./types";
...
export const ShopReducer = (state = initalState, action: ShopAction) => {
  switch (action.type) {
    ...
    case REMOVE_PRODUCT_FROM_CART: 
      ...
      if (cartProductToRemoveIndex && state.cart[cartProductToRemoveIndex].amount > 1) {
